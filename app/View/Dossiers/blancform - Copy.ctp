...
<?php echo $this->Form->create('Dossier',array('type' => 'file')); ?>
<div id="tabs">
...
<?php 
	...
	{
		echo '<li><a href="#tabs-'.$section['Section']['ordre'].'">'.$section['Section']['nom'].'</a></li>';	
		
		
	}
	echo '<li><a href="#tabs-'.(count($sections)+1).'">Choix Cursus</a></li>';
	echo '</ul>';
...
<?php
	...
	foreach ($sections as $section) 
	{
		 echo '<div id="tabs-'.$section['Section']['ordre'].'">';
	...
	<div id="tabs-<?php echo count($sections)+1;   ?>">
