<div class="dossiers index">
	...
	<tr>
		...
		<td><?php echo h($dossier['Dossier']['activated']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $dossier['Dossier']['id']), null, __('Are you sure you want to delete # %s?', $dossier['Dossier']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
