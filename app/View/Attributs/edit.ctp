...
<?php echo $this->Form->create('Attribut'); ?>
	<fieldset>
		<legend><?php echo __('Edit Attribut'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Attribut.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Attribut.id'))); ?></li>
