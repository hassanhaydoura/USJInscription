...
<div class="users form">
 ...
 <?php echo $this->Html->link(__('Generer PDF'), array('controller' => 'Users', 'action' => 'pdf3'), array('target'=>'_blank','escape'=>false)); ?>
&nbsp;&nbsp;&nbsp;
<?php echo $this->Html->link(__('Generer PDF'), array('controller' => 'Users', 'action' => 'pdf'), array('target'=>'_blank','escape'=>false)); ?>
&nbsp;&nbsp;&nbsp;
<?php echo $this->Html->link(__('Generer PDF'), array('controller' => 'Users', 'action' => 'pdf2'), array('target'=>'_blank','escape'=>false)); ?>
&nbsp;&nbsp;&nbsp;
<?php echo $this->Html->link(__('Modifier'), array('controller' => 'users', 'action' => 'blancform'));  ?>
&nbsp;&nbsp;&nbsp;
</span>
